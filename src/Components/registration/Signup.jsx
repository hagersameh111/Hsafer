              ...
              <div className='space-y-4   rounded-md p-4 relative'>
                ...
                <div>
                       ...
                       <div className=" font-mono text-[14px]" >
                        ...
                        <button type="submit"   className="bg-quaternary opacity-95 text-white hover:scale-105 px-4 py-2 rounded-full duration-200 absolute  left-1/2 -translate-x-1/2">SIGNUP</button>
                        </div>
                       <div className=' rounded-md p-4 flex flex-col space-y-8'>
                       <div className="relative flex justify-center items-center py-4">
                        <span>
                        Already Have An Account?
                        <Link to={"/SignUp"} className="text-quaternary"> Signin</Link>
                        </span>
                       </div>
                       </div>

...
const Footer = () => {
  ...
  return (
    <footer className=" relative bg-secondary text-white">
      <div className="absolute top-0 left-0 w-[100%] overflow-hidden bg-secondary ">
      <svg data-name="Layer 1"
                ...
                preserveAspectRatio="none">
                    <path
                        ...
                        className="relative block h-[600px] fill-primary"></path>
                </svg>
        ...
        <div>
           ...
           <li className="my-4 list-none">Hotels</li>
         ...
         <h6 className="text-center">&copy; right Hsaver Travels {Year}</h6>
     </div>
   </footer>
  )
}
